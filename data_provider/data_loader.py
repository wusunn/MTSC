...
class UEAloader(Dataset):
    ...
    def __getitem__(self, ind):
        ...
        # 注：父仓库中此处有 augmentation 逻辑（augmentation_ratio > 0 时调用 run_augmentation_single），
        # 为保持最小化依赖，这里不引入 augmentation；如需启用，请从父仓库补充 utils/augmentation.py。
